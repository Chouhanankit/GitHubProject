    ...
    if (isLoading) {
        return (
            <div className="container bg-[#141C2F] h-[100vh]">
                <h1 className='text-2xl  text-red-400 justify-center items-center'>Loading....</h1>
            </div>
        )
    }
        ...
        return (
            <>
                <div className='sm:w-[100%] w-full h-auto flex flex-col items-center justify-center'>
                    ...
                    <div className="sm:p-5 p-4 w-full h-[60vh] sm:flex justify-center text-sm text-gray-500  bg-[#1F2A48] border border-gray-400 rounded-2xl shadow-sm  ">
                        <div className='flex justify-center w-auto sm:px-10 sm:mt-0 mt-2 sm:visible '>
